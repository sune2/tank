...
// var nearestPointSP = function(s, p) {
//   var r = projection(s, p);
//   if (intersectSP(s, r)) {
//     return r;
//   }
//   return s.p1.subtract(p).magnitude() < s.p2.subtract(p).magnitude() ? s.p1 : s.p2;
// };

// Segment.prototype.nearestPointTo = function(s) {
//   if (Segment.intersect(this, s)) {
//     return Segment.crosspoint(this, s);
//   }
//   var dis = 1e10;
//   var res;
//   var check = function(p) {
//     if (dis > distanceSP(s, p)) {
//       dis = distanceSP(s, p);
//       res = p;
//     }
//   };
//   check(nearestPointSP(this, s.p1));
//   check(nearestPointSP(this, s.p2));
//   check(this.p1);
//   check(this.p2);
//   return res;
// };
